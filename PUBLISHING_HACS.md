# Publikacja w HACS - Hierarchical Tasks 0.2.1
...
W **Releases > Draft a new release** utwórz tag `v0.2.1` wskazujący
...
Numer w `manifest.json`, `const.py` i karcie pozostaje `0.2.1`; tag może
